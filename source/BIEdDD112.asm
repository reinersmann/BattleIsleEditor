* BIEdDD1 V 1.2 - Werner Reinersmann 01.11.1993
...
VorAb4
	bsr	InitParts
	bsr	InitUnits
	lea	ErstFenstParts(pc),a0
	movea.l	RP3(pc),a2
	movea.l	Part(pc),a3
	moveq	#25,d2
	moveq	#103,d3
	bsr	AllePUs
	lea	ErstFenstUnits(pc),a0
	movea.l	RP4(pc),a2
	movea.l	Unit(pc),a3
	moveq	#34,d2
	moveq	#54,d3
...
SL_Zurueck2
	...
	bsr	Schreib
	lea	RechnePmp(pc),a0
	move.b	0(a5,d6.w),7(a0)
	move.b	1(a5,d6.w),8(a0)
	movea.l	RP1(pc),a1
	moveq	#0,d0
	moveq	#34,d1
	bsr	Schreib
...
Part		dc.l	$10000,2080
PartIDataZgr	dc.l	$10002,49920
Unit		dc.l	$10000,1080
UnitIDataZgr	dc.l	$10002,25920
Karte		dc.l	$10000,8192
NeuKarte	dc.l	$10000,16512
...
Titel1		dc.b	'BI Editor DD1 - � 1993 Werner Reinersmann',0
...
SText1		dc.b	'  T-3 SCORPION',0
SText2		dc.b	'  TLAV INVADER',0
SText3		dc.b	'  G-2 GIANT',0
SText4		dc.b	'  CAS FIREBIRD',0
SText5		dc.b	'  XA-7 RAVEN',0
SText6		dc.b	'  XF-7 MOSQUITO',0
SText7		dc.b	'  SC-P MERLIN',0
SText8		dc.b	'  HG-12 ANGEL',0
SText9		dc.b	'  SC-T PROVIDER',0
SText10		dc.b	'  FAV BUSTER',0
SText11		dc.b	'  AD-5 BLITZ',0
SText12		dc.b	'  T-7 CRUSADER',0
SText13		dc.b	'  T-4 GLADIATOR',0
SText14		dc.b	'  R-1 DEMON',0
SText15		dc.b	'  AD-9 SPHINX',0
SText16		dc.b	'  64',0
SText17		dc.b	'  56',0
SText18		dc.b	'  48',0
SText19		dc.b	'  40',0
...
Farbe		dc.w	$000,$ccc,$f32,$920,$600,$778,$445,$223
		dc.w	$562,$fc3,$da3,$a82,$543,$876,$121,$320
		dc.w	$000,$ccc,$2cf,$05d,$137,$778,$445,$223
		dc.w	$562,$fc3,$da3,$a82,$543,$876,$121,$320
		dc.w	$000,$ccc,$ecb,$ba8,$864,$778,$445,$223
		dc.w	$562,$b93,$a73,$862,$543,$876,$121,$320
		dc.w	$000,$ccc,$9c4,$662,$440,$778,$445,$223
		dc.w	$562,$b93,$a73,$862,$543,$876,$121,$320
KFarbe		dc.b	07,06,05,09,10,10,10,11,11,11,11,11,11,11,11,08,08
		dc.b	14,14,15,15,05,15,15,15,01,01,15,01,01,01,01,01,01
		dc.b	01,01,01,01,01,01,01,01,01,01,01,01,01,01,01,01,05
		dc.b	05,05,05,05,05,05,05,05,05,05,15,15,03,05,00,00,00
		dc.b	00,00,00,12,03,05,00,00,00,00,00,00,00,12,03,05,00
		dc.b	00,00,05,05,01,01,01,01,13,13,12,08,01,01,13,13,05
		dc.b	05,01
KWert		dc.b	48,48,46,65,66,67,68,69,3,31,0
PartPos		dc.l	38384,37732,38058,12184,12510,12932,13354,08808
		dc.l	09230,09652,10074,10496,10918,11340,11762,22292
		dc.l	22714,36044,36466,25840,26262,35488,00004,00426
		dc.l	00848,01270,01692,02114,02536,02958,03380,07542
		dc.l	08386,28314,28736,29158,29580,30002,30424,30846
		dc.l	31268,31690,32112,32534,32956,33378,33800,34222
		dc.l	34644,35066,17650,18072,18494,18916,19338,19760
		dc.l	20182,20604,21026,21448,21870,36888,37310,23136
		dc.l	23462,23884,24210,24536,24862,25188,25514,03802
		dc.l	04128,04454,04876,05202,05528,05854,06276,06698
		dc.l	07120,15598,15924,16250,16672,16998,17324,13776
		dc.l	14198,14620,14946,15272,26684,26914,27240,27566
		dc.l	27892,35910,07964,38710,39132,39554,39976,40398
UnitPos		dc.l	35504,34140,12940,11776,20548,19204,17780,16416
		dc.l	25536,24152,28244,26900,23044,21952,32990,31886
		dc.l	30712,29548,05748,04656,07916,06872,10432,09008
		dc.l	03548,02472,43396,42304,40980,39616,46326,44536
		dc.l	46522,44762,50440,48172,50868,48440,55364,53228
		dc.l	55696,53656,59934,57580,60330,58040,63622,62278
		dc.l	38252,36888,01248,00004,15468,14520
...
TypTeilListe	dc.b	00,63,00,00,64,01
		dc.b	01,81,02,01,82,00,01,83,01
		dc.b	02,71,02,02,72,00,02,73,01
TeilTypListe	dc.b	01,20
		dc.b	63,00,64,00,65,05,66,05,67,05,68,05,69,05,70,05,71,02
		dc.b	72,02,73,02,74,07,75,07,76,07,81,01,82,01,83,01,84,06
		dc.b	85,06,86,06
		dc.b	02,16
		dc.b	12,03,13,03,24,03,25,03,28,03,29,03,30,03,31,03,32,04
		dc.b	33,04,38,03,39,03,40,04,41,04,46,03,47,03
		dc.b	03,16
		dc.b	30,09,31,08,32,08,33,09,34,09,35,08,36,08,37,09,38,09
		dc.b	39,08,40,08,41,09,42,09,43,08,44,08,45,09
AenderListe	dc.l	65,00,-1,00,66,00,-2,00,67,01,01,00,68,01,01,-1
		dc.l	69,-1,01,00,70,-1,01,-1,74,00,-1,00,75,01,01,00
		dc.l	76,-1,01,00,84,01,01,01,85,01,01,00,86,02,00,00
...
HQTeile2	dc.b	05,68,67,66,70,69,65
FBFelder	dc.l	0,0,-2,1,0,-1,1,-1,-1
FBTeile1	dc.b	02,00,00,00
FBTeile2	dc.b	02,86,85,84
DPFelder	dc.l	1,0,-1,1,0,1,0,1,0
DPTeile1	dc.b	02,00,00,00
DPTeile2	dc.b	02,75,76,74
ModTeil		dc.b	35,42,34,36,41,39,37,40,38
		dc.b	52,57,50,51,58,55,54,56,53
