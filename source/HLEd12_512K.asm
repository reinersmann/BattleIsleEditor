* HLEd12 512K Chip - Werner Reinersmann 11.04.1994
...
CopyImage
	...
	lea	Image(pc),a0
	movea.l	10(a0),a0
	movea.l	ImageZgr(pc),a1
	move.l	#480,d0
	jsr	-624(a6)
	movem.l	(sp)+,d0-d1/a0-a1/a6
	lea	Image(pc),a1
	move.l	ImageZgr(pc),10(a1)
	rts
...
PartIDataZgr	dc.l	$10004,84000
Unit		dc.l	$10000,2040
UnitIDataZgr	dc.l	$10004,48960
Karte		dc.l	$10000,8192
Shop		dc.l	$10000,4368
ImageZgr	dc.l	$10002,480
MemListeEnde

FontName	dc.b	'topaz.font',0
Titel1		dc.b	'HL Editor 1.2 - � 1993 Werner Oluts',0
